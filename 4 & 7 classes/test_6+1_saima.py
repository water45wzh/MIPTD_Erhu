...
def test(**kwargs):
    ...
    another = ["颤音","上滑音","下滑音","顿弓","上颤音","连线滑音","其他"]

    y, sr = lb.load(os.path.join(file_path, "赛马_L.wav"), sr=None)
    feature = lb.feature.melspectrogram(y=y, sr=sr, hop_length=2205, n_mels=128)

# ===========================================================做测试========================================================
    with open(os.path.join(file_path, "赛马_L_6+1_ref.txt"), "r", encoding='gbk') as fp:
