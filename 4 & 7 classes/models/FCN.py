...
if __name__ == "__main__":
    batch_size, n_class, h, w = 1, 10, 128, 362
    print("11")
    # test output size
    vgg_model = VGGNet(requires_grad=True)
    input = torch.autograd.Variable(torch.randn(batch_size, 3, 128, 362))
    ...
    #
    fcn_model = FCN16s(pretrained_net=vgg_model, n_class=n_class).cuda()
